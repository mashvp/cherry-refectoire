...
export default function TextScroll({children, className = '', node = 'p',  callback = (el, prog)=>{el.style.opacity = String(prog)}, word = false, boxed = false, backward, interval = 0.1, selfAnchor = 0.5, windowPosition = 0.5, windowLength = 0.5, min = 0, max = 1}:TextSpanerType) {
